 ...
 * Desc:
 */
public class ScoreTrendNew extends View {
    ...
    public ScoreTrendNew(Context context) {
        super(context);
        initConfig(context, null);
        init();
    }

    public ScoreTrendNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        initConfig(context, attrs);
        init();
    }

    public ScoreTrendNew(Context context, AttributeSet attrs, int defStyleAttr) {

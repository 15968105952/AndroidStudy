...
import com.lahm.learndaemon.view.ScoreTrendNew;

import java.util.ArrayList;
import java.util.List;

public class AxisRecordForCePingActivity extends BaseActivity {
    private String TAG = AxisRecordForCePingActivity.class.getSimpleName();
    ...
    private ScoreTrendNew lineChart;
